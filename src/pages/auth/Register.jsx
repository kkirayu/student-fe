...
const Register = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    confirmPassword: '',
    phone_number: '',
    role: 'Pemilik Hewan', // Default role
    address: ''
  });
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Register Data:', {
      ...
      password_hash: formData.password, // Simulated
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea 
                      ...
                      className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none transition-all resize-none"
